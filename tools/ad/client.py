...
BHE_PORT = 8080
BHE_SCHEME = "http"
BHE_TOKEN_ID = "d8ac02e9-41f9-4452-a07a-641881ee7f9b"
BHE_TOKEN_KEY = "rVDxyAbeU8amJZ4gkPWzXn+IPAsEa7jyH0OB22ch7eSjrRh7F73kIw=="
...
class Client(object):
    ...
    def get_domains(self) -> list[Domain]:
        ...
        for domain in payload:
            ...
            domains.append(Domain(domain["name"], domain["id"], domain["collected"], domain["type"], impact_value=0)) # domain["impactValue"]))
